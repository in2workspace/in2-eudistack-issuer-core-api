...
//
//    @Test
//    void testRetrySignUnsignedCredential_LabelCredential_UsesSubjectEmailAndCredentialIdToSend() {
...
//        when(updatedProcedure.getSubjectEmail()).thenReturn("foo@bar.com");
//
