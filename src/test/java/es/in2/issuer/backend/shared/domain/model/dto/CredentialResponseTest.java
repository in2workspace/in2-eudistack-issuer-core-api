...
class CredentialResponseTest {
    ...
    void testConstructorAndGetters() {
        ...
        Long interval = 3600L;
        // Act
        CredentialResponse responseDTO = new CredentialResponse(expectedCredentials, transactionId, interval);
        // Assert
    ...
    void lombokGeneratedMethodsTest() {
        ...
        Long interval = 3600L;
        // Act
        CredentialResponse dto1 = new CredentialResponse(List.of(expectedCredential), transactionId, interval);
        CredentialResponse dto2 = new CredentialResponse(List.of(expectedCredential), transactionId, interval);
        // Assert
