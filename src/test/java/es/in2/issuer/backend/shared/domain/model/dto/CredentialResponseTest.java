...
class CredentialResponseTest {
    ...
    void testConstructorAndGetters() {
        ...
        List<CredentialResponse.Credential> expectedCredentials = List.of(
                CredentialResponse.Credential.builder()
                        ...
                        .build());
        // Act
        CredentialResponse responseDTO = new CredentialResponse(expectedCredentials, transactionId, notificationId);
        // Assert
    ...
    void lombokGeneratedMethodsTest() {
        ...
        CredentialResponse.Credential expectedCredential = CredentialResponse.Credential.builder()
                ...
                .build();
        // Act
        CredentialResponse dto1 = new CredentialResponse(List.of(expectedCredential), transactionId, notificationId);
        CredentialResponse dto2 = new CredentialResponse(List.of(expectedCredential), transactionId, notificationId);
        // Assert
